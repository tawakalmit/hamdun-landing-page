...
export default function Jumbotron() {
  return (
    <div className='mt-16 w-full flex flex-col md:flex-row items-center justify-center md:h-[20rem] bg-[url("/asset/cover.jpg")] p-5 md:p-0'>
        <Image src="/asset/logo.png" width={230} height={230} alt="logo" />
